...
@push('footer')
    <svg class="hidden">
        <symbol id="svg-loading-spinner" viewBox="0 0 24 24">
    ...
    <svg class="hidden">
        <symbol id="svg-processing-spinner" viewBox="0 0 24 24">
    ...
    <svg class="hidden">
        <symbol id="svg-download-arrow" viewBox="0 0 24 24">
            <path d="M16 11h5l-9 10-9-10h5v-11h8v11zm1 11h-10v2h10v-2z"></path>
        </symbol>
    </svg>

    <svg class="hidden">
        <symbol id="svg-unlink" viewBox="0 0 1792 1792">
    ...
    <svg class="hidden">
        <symbol id="svg-link" viewBox="0 0 1792 1792">
    ...
    <svg class="hidden">
        <symbol id="svg-remove" viewBox="0 0 1792 1792">
